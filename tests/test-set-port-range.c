...
int main (int argc, char **argv)
{
  ...
  nice_agent_set_port_range (agent, stream1, 1, 8888, 8888, 9000);
  nice_agent_set_port_range (agent, stream1, 2, 8888, 8888, 9000);
  ...
  nice_agent_set_port_range (agent, stream1, 2, 9999, 9999, 9000);
